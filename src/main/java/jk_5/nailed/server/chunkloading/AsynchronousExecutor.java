...
public final class AsynchronousExecutor<P, T, C, E extends Throwable> {
     ...
     * @see jk_5.nailed.server.chunkloading.AsynchronousExecutor
     */
     ...
     * <p>
     * If no callbacks remain for a given parameter, then the {@link jk_5.nailed.server.chunkloading.AsynchronousExecutor.CallBackProvider CallBackProvider's} stages may be omitted from execution.
    ...
    public boolean drop(P parameter, C callback) throws IllegalStateException {
        ...
        if (task == null) {
            ...
            logger.info("This should not happen. Please report this error to the nailed team.");
            return false;
        }
