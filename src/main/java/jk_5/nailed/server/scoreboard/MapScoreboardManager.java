...
public class MapScoreboardManager implements ScoreboardManager, NetworkedScoreboardManager {
    ...
    public MapScoreboardManager(NailedMap map) {
        this.map = map;
    }
    ...
    public void onPlayerJoined(Player player){
        NailedPlayer np = ((NailedPlayer) player);
    ...
    public void sendPacket(Packet packet) {
        for (Player player : map.players()) {
            ((NailedPlayer) player).sendPacket(packet);
        }
    }
}
