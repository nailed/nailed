...
import jk_5.nailed.launch.NailedLauncher;
...
public class NailedPlatform implements Platform {
    ...
    private static final File runtimeDirectory = NailedLauncher.getGameDirectory();
    private static final Logger logger = LogManager.getLogger();
    private static final Config config = Settings.load();
    private static final EventBus globalEventBus = new EventBus();
    private static final File pluginsDir = new File(runtimeDirectory, "plugins");
