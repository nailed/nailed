 ...
 * @author jk-5
 */
case class ImmutableXmlGameRules(e: Element, parent: GameRules = null) extends GameRules {

  val rules = mutable.HashMap[String, String]()

  for(o <- e.getChildren){
    rules.put(o.getName, o.getText)
  }
  ...
  override def toString = s"ImmutableXmlGameRules{parent=${parent.toString}}"
}
