...
import java.io.{ByteArrayOutputStream, ByteArrayInputStream, IOException, File}
import java.util.jar.{JarEntry, JarOutputStream, Pack200, JarInputStream}
import java.util.regex.Pattern

import LZMA.LzmaInputStream
import com.google.common.collect.{ArrayListMultimap, ListMultimap}
import com.google.common.hash.Hashing
import com.google.common.io.{ByteStreams, ByteArrayDataInput, Files}
